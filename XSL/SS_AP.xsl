...
<xsl:stylesheet
  ...
  <xsl:template name="FormatDateIta">
    ...
    <xsl:variable name="year" select="substring($DateTime,2,4)" />
    <xsl:variable name="month" select="substring($DateTime,7,2)" />
    <xsl:variable name="day" select="substring($DateTime,10,2)" />
